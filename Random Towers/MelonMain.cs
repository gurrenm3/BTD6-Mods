...
namespace Random_Towers
{
    public class MelonMain : MelonMod
    {
        ...
        int numRandomizedTowers = 0;
        float timeToNextRandom = 0f;
        Il2CppSystem.Collections.Generic.List<TowerToSimulation> towerToSimulations = new Il2CppSystem.Collections.Generic.List<TowerToSimulation>();
